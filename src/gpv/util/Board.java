...
public class Board {
	 ...
	 * @param initializers
	 */
	public Board(int maxRows, int maxColumns, List<SquareInitializer> initializers) {
	 ...
	 * 
	 * @param initializers
	 *            a configuration consisting of a list of SquareInitializers for those
	 *            squares containing pieces.
	 */
