...
/**
 * This is a class that is used to initialize one square on a 2D board. The appropriate
 * Board instance can then initialize the itself when given a collection of these. It is
 * up to the board or some other class to verify the validity of the contents of a
 * SquareInitializer instance. This is strictly a data object.
 * 
 * @version Feb 23, 2020
 */
public class SquareInitializer {
	...
	/**
	 * Factory method for the initializer. This allows for having an object pool that is
	 * shared if necessary.
	 * 
	 * @param p
	 *            The piece
